...
class Api extends HttpClient {
    constructor() {
        ...
        this.id = {
             ...
             * @secure
             */
            getImage: (id, query, params = {}) => this.request({
                path: `/img/${id}`,
                method: 'GET',
                query: query,
                secure: true,
        ...
        this.details = {
             ...
             * @secure
             */
            updateMetadata: (mediaItemId, params = {}) => this.request({
        ...
        this.list = {
             ...
             * @secure
             */
            addList: (data, params = {}) => this.request({
                path: `/api/list`,
                method: 'PUT',
                body: data,
                secure: true,
             ...
             * @secure
             */
            updateList: (data, params = {}) => this.request({
                path: `/api/list`,
                method: 'PATCH',
                body: data,
                secure: true,
             ...
             * @secure
             */
            getList: (query, params = {}) => this.request({
                path: `/api/list`,
                method: 'GET',
                query: query,
                secure: true,
             ...
             * @secure
             */
            deleteList: (query, params = {}) => this.request({
                path: `/api/list`,
                method: 'DELETE',
                query: query,
                secure: true,
             ...
             * @secure
             */
            getListItems: (query, params = {}) => this.request({
                path: `/api/list/items`,
                method: 'GET',
                query: query,
                secure: true,
        ...
        this.listItem = {
             ...
             * @secure
             */
            removeItemFromList: (query, params = {}) => this.request({
                path: `/api/list-item`,
                method: 'DELETE',
                query: query,
                secure: true,
        ...
        this.lists = {
             ...
             * @secure
             */
            getUsersLists: (query, params = {}) => this.request({
                path: `/api/lists`,
                method: 'GET',
                query: query,
                secure: true,
        ...
        this.plex = {
             ...
             * @secure
             */
            plexWebhook: (params = {}) => this.request({
                path: `/api/plex`,
                method: 'POST',
                secure: true,
                ...params,
        ...
        this.progress = {
             ...
             * @secure
             */
            addByExternalId: (data, params = {}) => this.request({
             ...
             * @secure
             */
            deleteById: (progressId, params = {}) => this.request({
        ...
        this.importGoodreads = {
             ...
             * @secure
             */
            import: (data, params = {}) => this.request({
        ...
        this.importTrakttv = {
             ...
             * @secure
             */
            stateStream: (params = {}) => this.request({
